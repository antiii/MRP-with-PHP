                 ...
                 <small><table id="bootstrap-data-table-export" class="table table-striped table-bordered">
						...
						?>
                         <tr>
							...
							<td><center><a href="DetailPembelian.php?kode_faktur=<?php print $m['kode_faktur'];?>"><button class="btn btn-info btn-sm"><i class="fa fa-search"></i></button></a>
							<a href="KonfirmasiPesanBB.php"><button class="btn btn-info btn-sm">Konfirmasi<i class="fa fa-search"></i></button></a></center></td>
                             </tr>
						<?php 
									}
								}
