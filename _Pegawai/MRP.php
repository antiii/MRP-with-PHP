                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
								...
								<p align="right"><a href="TabelMRP2.php"> <button style="margin-bottom:20px" class="btn-sm btn-info col-md-3"><span class="glyphicon glyphicon-plus"></span>Lihat Perhitungan MRP</button> </a></p>
										<?php
        				$i=0; 
