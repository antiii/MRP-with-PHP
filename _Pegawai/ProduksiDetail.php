                ...
                <div class="row">
                    <div class="col-md-12">
						...
						?>
							...
							$tanggal = date('d-m-Y'); 
							$result = mysqli_query($con, "SELECT SUM(produksi_total) as Total FROM produksi WHERE produksi_tgl='$tanggal' and kode_produk='$kode_produk'");
                        ...
                        <thead>
												...
												<?php
													...
													$tgl = date('d-m-Y');
														...
														$result8 = mysqli_query($con, "SELECT * FROM produksi where kode_produk='$kode_produk'");	
														while($v = mysqli_fetch_array($result8))
														{
