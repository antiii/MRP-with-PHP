            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
					   ...
					   <!-- Penjualan-->
                       <li class="active">
                        <a href="DataPenjualan.php"> <i class="menu-icon fa fa-list-alt"></i><font color='white'>Data Penjualan</font></a>
                    </li>
					...
					<li class="menu-item-has-children dropdown active">
					 ...
					 <!-- Laporan -->
                       <!-- Penjualan-->
                       <li class="active">
                        <a href="LaporanPenjualan.php"> <i class="menu-icon fa fa-list"></i><font color='white'>Laporan Penjualan</font></a>
                    </li>
